...
/******/ 	var hotCurrentHash = "33d6dab2451213dc8c6f"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keyhandler = __webpack_require__(52);
	...
	var _container3 = __webpack_require__(53);
	
	var _container4 = _interopRequireDefault(_container3);
	
	var _public = __webpack_require__(54);
	...
	var app = _backbone2.default.View.extend({
		...
		initialize: function initialize(options) {
			console.log(this.$el);
			this.template = _container4.default; //Handlebars.compile($(options.template).html());
		...
		renderSlides: function renderSlides() {
			var slides = new _container2.default.collection();
			var container = new _container2.default.view({ el: this.$el.find('.slide'), animationDuration: 250, collection: slides });
		...
		renderProgress: function renderProgress() {
			var progress = new _timer2.default({ el: (0, _jquery2.default)('.progress'), duration: window.slideDuration, shouldAnimate: false });
			_backbone2.default.Events.on('render:done', progress.start, progress);
	...
	// Switcharoo.App = app;
	console.log((0, _jquery2.default)('.container'));
	var app = new app({ el: (0, _jquery2.default)('.container') });
	app.render();
	window.app = app;
	
	var keyHandler = new _keyhandler2.default((0, _jquery2.default)(document));
	keyHandler.listen();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _velocityAnimate = __webpack_require__(39);
	...
	var _twitter = __webpack_require__(44);
	
	var _twitter2 = _interopRequireDefault(_twitter);
	
	var _instagram = __webpack_require__(46);
	
	var _instagram2 = _interopRequireDefault(_instagram);
	
	var _textSlide = __webpack_require__(49);
	
	var _textSlide2 = _interopRequireDefault(_textSlide);
	
	var _imageSlide = __webpack_require__(50);
	
	var _imageSlide2 = _interopRequireDefault(_imageSlide);
	
	var _program3 = __webpack_require__(43);
	
	var _program4 = _interopRequireDefault(_program3);
	
	var _twitter3 = __webpack_require__(45);
	
	var _twitter4 = _interopRequireDefault(_twitter3);
	
	var _instagram3 = __webpack_require__(47);
	
	var _instagram4 = _interopRequireDefault(_instagram3);
	...
	var view = _backbone2.default.View.extend({
		...
		initialize: function initialize(options) {
			...
			_backbone2.default.Events.on('slide:next', this.slideInNext, this);
		...
		rerender: function rerender() {
			if (this.newSlides) delete this.newSlides;
		...
		renderInfo: function renderInfo() {
			...
			this.collection.each(function (slide) {
				if (!slide.get('visible')) return;
	
				var template = slide.get('type') === 'image' ? imageSlideTemplate : _textSlide2.default;
				var view = new _info2.default.view({ model: slide, template: template });
				slides.push(view);
				view.render();
			});
	
			if (slides.length === 1) slides[0].animatableElements().css('opacity', 1);
	
			return slides;
		},
	
		renderSpecial: function renderSpecial() {
			var special = [this.program(), this.twitter(), this.instagram()];
			return special;
		},
	
		program: function program() {
			if (this.programView) delete this.programView;
	
			var model = new _program2.default.model();
			var view = new _program2.default.view({ model: model, template: _program4.default });
		...
		twitter: function twitter() {
			if (this.twitterView) delete this.twitterView;
	
			var model = new _twitter2.default.model();
			var view = new _twitter2.default.view({ model: model, template: _twitter4.default });
		...
		instagram: function instagram() {
			if (this.instagramView) delete this.instagramView;
	
			var model = new _instagram2.default.model();
			var view = new _instagram2.default.view({ model: model, template: _instagram4.default });
		...
		start: function start() {
			...
			(0, _velocityAnimate2.default)(slide.animateIn(), 'transition.slideUpIn');
			slide.trigger('visible');
			_backbone2.default.Events.trigger('render:done');
			this.startTimers();
		},
		...
		startTimers: function startTimers() {
			...
			setInterval(function () {
				self.getProgram = true;
			}, TWO_MINUTES);
			setInterval(function () {
				self.getTwitter = true;
			}, TWO_MINUTES);
			setInterval(function () {
				self.getInstagram = true;
			}, TWO_MINUTES);
		},
		...
		slideInNext: function slideInNext() {
			...
			function complete() {
				if (self.nextIndex() === 0) self.setNext();
				...
				if (self.numberOfSlides() !== 1 || self.isAnimatedOut) {
					...
					(0, _velocityAnimate2.default)(next.animateIn(), 'transition.slideUpIn');
				}
				_backbone2.default.Events.trigger('slide:next:done');
			...
			if (this.numberOfSlides() === 1) {
				...
				(0, _velocityAnimate2.default)(this.getSlide().animateOut(), 'transition.slideUpOut', {
					complete: complete
				});
			}
		},
		...
		getSpecial: function getSpecial(index) {
			var special = _underscore2.default.filter(this.special, function (special) {
		...
		getSlide: function getSlide(index) {
			...
			if (index < this.slides.length) return this.slides[index];
		...
		numberOfSlides: function numberOfSlides() {
			var special = _underscore2.default.reduce(this.special, function (mem, special) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _slide = __webpack_require__(41);
	
	var _slide2 = _interopRequireDefault(_slide);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var view = _slide2.default.extend({
	
		className: 'info',
	
		animatableElements: function animatableElements() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Slide = _backbone2.default.View.extend({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _program = __webpack_require__(43);
	...
	var view = _slide2.default.extend({
		...
		initialize: function initialize() {
			...
			this.template = _program2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "        <li>\n            <div class=\"room\">"
	    ...
	    + "</div>\n            "
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.speakers : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\n        </li>\n";
	},"2":function(container,depth0,helpers,partials,data) {
	    var helper;
	
	  return "<div class=\"speakers\">"
	    + container.escapeExpression(((helper = (helper = helpers.speakers || (depth0 != null ? depth0.speakers : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"speakers","hash":{},"data":data}) : helper)))
	    + "</div>";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, helper, alias1=depth0 != null ? depth0 : {};
	
	  return "<div class=\"slide-padding\">\n    <h1>"
	    ...
	    + "</h1>\n    <ul>\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.presentations : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "    </ul>\n</div>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _twitter = __webpack_require__(45);
	...
	var view = _slide2.default.extend({
		...
		initialize: function initialize() {
			this.template = _twitter2.default; //Handlebars.compile($(this.template).html());
			this.model.on('sync', this.render, this);
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"slide-padding\">\n    <h1>#JavaZone</h1>\n    <ul>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.tweets : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "    </ul>\n</div>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _velocity = __webpack_require__(48);
	...
	var view = _slide2.default.extend({
		...
		initialize: function initialize() {
			this.template = _instagram2.default; //Handlebars.compile($(this.template).html());
			this.model.on('sync', this.render, this);
		...
		swapImages: function swapImages() {
			(0, _velocityAnimate2.default)(this.$el.find('.first').get(), 'transition.flipXOut');
			(0, _velocityAnimate2.default)(this.$el.find('.second').get(), 'transition.flipXIn');
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"slide-padding\">\n    <h1>#JavaZone</h1>\n    <ul>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.media : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "    </ul>\n</div>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timer = _backbone2.default.View.extend({
	
		initialize: function initialize(options) {
			this.duration = options.duration || 4000;
			this.shouldAnimate = options.shouldAnimate;
			_backbone2.default.Events.on('slide:next:done', this.start, this);
			_backbone2.default.Events.on('key:left', this.prev, this);
			_backbone2.default.Events.on('key:right', this.next, this);
			_backbone2.default.Events.on('key:space', this.toggle, this);
		},
	
		start: function start() {
			if (this.shouldAnimate) this.animate();else this.countdown();
		},
	
		animate: function animate() {
			this.timeoutID = ANIMATE_ID;
			(0, _velocityAnimate2.default)(this.$el.get(), {
				width: '100%'
			}, {
				easing: 'linear',
				...
				complete: function complete() {
					$(this).css('width', 0);
					_backbone2.default.Events.trigger('slide:next');
				}
			});
		},
		...
		toggle: function toggle() {
			if (typeof this.timeoutID === 'undefined') this.play();else this.pause();
		},
	
		pause: function pause() {
			if (this.timeoutID === ANIMATE_ID) (0, _velocityAnimate2.default)('stop');
...
/***/ function(module, exports, __webpack_require__) {
	...
	Keyhandler.prototype.listen = function () {
		this.container.keydown(function (ev) {
			...
			switch (ev.keyCode) {
				case LEFT:
					_backbone2.default.Events.trigger('key:left');
					break;
				case RIGHT:
					_backbone2.default.Events.trigger('key:right');
					break;
				case SPACE:
					_backbone2.default.Events.trigger('key:space');
					break;
			}
		});
	};
