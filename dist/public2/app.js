...
var _user$project$Models_Info$videoView = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('slides__slide slide slide--video')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
...
var _user$project$Models_Info$imageView = function (model) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('slides__slide slide slide--image')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('slide__image'),
...
var _user$project$Models_Info$textView = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('slides__slide slide')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
...
var _user$project$Models_Tweet$hashView = function (s) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('tweet__hash')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Models_Tweet$atView = function (s) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('tweet__at')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(s)
...
var _user$project$Models_Tweet$textView = function (s) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('tweet__text')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(s)
...
var _user$project$Models_Tweet$tTweet = _Bogdanp$elm_combine$Combine$rec(
	function (_p2) {
		var _p3 = _p2;
		return _Bogdanp$elm_combine$Combine$many(
			_Bogdanp$elm_combine$Combine$choice(
				_elm_lang$core$Native_List.fromArray(
					[_user$project$Models_Tweet$tText, _user$project$Models_Tweet$tAt, _user$project$Models_Tweet$tHash])));
	});
...
var _user$project$Models_Slides$getNextIndex = function (model) {
	return _elm_lang$core$Native_Utils.eq(
		model.index + 1,
		_elm_lang$core$List$length(model.slides)) ? 0 : (model.index + 1);
};
...
var _user$project$Models_Slides$Model = F3(
	function (a, b, c) {
		return {slides: a, index: b, switching: c};
	});
var _user$project$Models_Slides$init = A3(
	...
	switch (_p3) {
		...
		default:
			return _elm_lang$core$Json_Decode$fail(
				A2(_elm_lang$core$Basics_ops['++'], 'Unknown slideType ', _p3));
	}
};
...
var _user$project$Models_Slides$slides = A2(_elm_lang$core$Json_Decode_ops[':='], 'slides', _user$project$Models_Slides$slideWrapperList);
		...
		switch (_p9.ctor) {
			...
			case 'HideSlide':
				var shouldChange = _elm_lang$core$Native_Utils.cmp(
					_elm_lang$core$List$length(model.slides),
					1) > 0;
				var nextIndex = _user$project$Models_Slides$getNextIndex(model);
				return shouldChange ? {
					ctor: '_Tuple2',
				...
				} : {ctor: '_Tuple2', _0: model, _1: _user$project$Models_Slides$hideSlide};
			case 'NextSlide':
				var nextIndex = _user$project$Models_Slides$getNextIndex(model);
				return {
					ctor: '_Tuple2',
	...
	switch (_p10.ctor) {
		case 'InfoWrapper':
			return A2(
				...
				_user$project$Models_Info$view(_p10._0));
		case 'TweetsWrapper':
			return A2(
				_elm_lang$html$Html_App$map,
				function (_p12) {
				...
				_user$project$Models_Tweets$view(_p10._0));
		case 'ProgramWrapper':
			return A2(
				_elm_lang$html$Html_App$map,
				function (_p13) {
				...
				_user$project$Models_Program$view(_p10._0));
		default:
			return A2(
				_elm_lang$html$Html_App$map,
				function (_p14) {
				...
				_user$project$Models_Votes$view(_p10._0));
	}
};
var _user$project$Models_Slides$view = function (model) {
	var slide = A2(_user$project$Models_Slides$getAt, model.index, model.slides);
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'switcharoo', _1: true},
						{ctor: '_Tuple2', _0: 'switcharoo--hidden', _1: model.switching}
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				var _p15 = slide;
				if (_p15.ctor === 'Just') {
					return _user$project$Models_Slides$viewSlide(_p15._0);
				} else {
...
var _user$project$Main$swapIfNewSlides = F3(
	function (model, newSlides, slidesCmd) {
		var _p0 = model.nextSlides;
		if (_p0.ctor === 'Just') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{slides: _p0._0, nextSlides: _elm_lang$core$Maybe$Nothing}),
				_1: slidesCmd
			};
		} else {
			return {
...
var _user$project$Main$RefetchFailed = function (a) {
	return {ctor: 'RefetchFailed', _0: a};
};
var _user$project$Main$RefetchSucceeded = function (a) {
	return {ctor: 'RefetchSucceeded', _0: a};
};
var _user$project$Main$refetchSlides = A3(
	_elm_lang$core$Task$perform,
	_user$project$Main$RefetchFailed,
	_user$project$Main$RefetchSucceeded,
	A2(_evancz$elm_http$Http$get, _user$project$Models_Slides$slides, '/data'));
...
var _user$project$Main$GetSucceeded = function (a) {
	return {ctor: 'GetSucceeded', _0: a};
};
var _user$project$Main$getSlides = A3(
	_elm_lang$core$Task$perform,
	_user$project$Main$GetFailed,
	_user$project$Main$GetSucceeded,
	A2(_evancz$elm_http$Http$get, _user$project$Models_Slides$slides, '/data'));
	...
	function (msg, model) {
		...
		switch (_p3.ctor) {
			...
			case 'GetSucceeded':
				return {
					...
					_0: A2(
						...
						A3(_user$project$Models_Slides$Model, _p3._0, 0, false),
						_elm_lang$core$Maybe$Nothing),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'GetFailed':
			...
			case 'RefetchSucceeded':
				var _p4 = _p3._0;
				return _elm_lang$core$Native_Utils.eq(_p4, model.slides.slides) ? {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none} : {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							nextSlides: _elm_lang$core$Maybe$Just(
								A3(_user$project$Models_Slides$Model, _p4, 0, false))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'RefetchFailed':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				var _p5 = A2(_user$project$Models_Slides$update, _p3._0, model.slides);
				var newSlides = _p5._0;
				var slidesCmd = _p5._1;
				var mappedCmd = A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$SlidesMsg, slidesCmd);
				return _elm_lang$core$Native_Utils.eq(newSlides.index, 0) ? A3(_user$project$Main$swapIfNewSlides, model, newSlides, mappedCmd) : {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{slides: newSlides}),
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('switcharoo')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
