...
var _user$project$Events$noBubble = {stopPropagation: true, preventDefault: false};
var _user$project$Events$onClickStopPropagation = function (msg) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'click',
		_user$project$Events$noBubble,
		_elm_lang$core$Json_Decode$succeed(msg));
};
...
var _user$project$Slide$slideIndex = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('slide__index'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(model.index),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Slide$encodeSlide = function (model) {
	return _elm_lang$core$Json_Encode$object(
		A2(
			_elm_lang$core$List$append,
			_elm_lang$core$Native_Utils.eq(model.id, '') ? {ctor: '[]'} : {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: '_id',
			...
			},
			{
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'body',
						_1: _elm_lang$core$Json_Encode$string(model.body)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'visible',
							_1: _elm_lang$core$Json_Encode$bool(model.visible)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'index',
								_1: _elm_lang$core$Json_Encode$string(model.index)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'type',
									_1: _elm_lang$core$Json_Encode$string(model.type_)
								},
								_1: {ctor: '[]'}
							}
						}
		...
		A2(
			...
			A2(
				...
				A2(
					...
					A2(
						_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
						_elm_lang$core$Json_Decode$succeed(_user$project$Slide$Model),
...
var _user$project$Slide$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Ports$fileUploadSucceeded(_user$project$Slide$FileUploaded),
			_1: {
				ctor: '::',
				_0: _user$project$Ports$fileUploadFailed(_user$project$Slide$FileUploadFailed),
				_1: {ctor: '[]'}
			}
		});
};
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('tabs__tab tabs__tab--active'),
							_1: {
								ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('tabs__tab'),
								_1: {
									ctor: '::',
									_0: _user$project$Events$onClickStopPropagation(_user$project$Slide$TextSlide),
									_1: {ctor: '[]'}
								}
							},
							{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('modal__slide'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('input modal__index'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$Slide$Index),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(model.index),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$placeholder('Index'),
												_1: {ctor: '[]'}
											}
										}
									}
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$id('MediaInputId'),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html_Events$on,
				...
				},
				{
					...
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$Events$onClickStopPropagation(_user$project$Slide$MediaSlide),
								_1: {ctor: '[]'}
							}
						},
						{
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('input modal__title'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Slide$Title),
											_1: {
												ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$Slide$Body),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('input modal__body'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(model.body),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$placeholder('Body'),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _user$project$Slide$editView = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.type_, 'text') ? _user$project$Slide$editTextView(model) : _user$project$Slide$editMediaView(model);
};
var _user$project$Slide$EditResponse = function (a) {
	return {ctor: 'EditResponse', _0: a};
};
...
var _user$project$Slide$editButton = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('slide__edit'),
			_1: {
				ctor: '::',
				_0: _user$project$Events$onClickStopPropagation(_user$project$Slide$Edit),
				_1: {ctor: '[]'}
			}
		},
		{
			ctor: '::',
			_0: _user$project$Slide$icon('pencil'),
			_1: {ctor: '[]'}
		});
};
var _user$project$Slide$DeleteResponse = function (a) {
	return {ctor: 'DeleteResponse', _0: a};
};
var _user$project$Slide$delete = function (model) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Slide$DeleteResponse,
		_elm_lang$http$Http$request(
			{
				method: 'DELETE',
				headers: {ctor: '[]'},
...
var _user$project$Slide$deleteButton = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('slide__delete'),
			_1: {
				ctor: '::',
				_0: _user$project$Events$onClickStopPropagation(_user$project$Slide$Delete),
				_1: {ctor: '[]'}
			}
		},
		{
			ctor: '::',
			_0: _user$project$Slide$icon('trash'),
			_1: {ctor: '[]'}
		});
};
var _user$project$Slide$CreateResponse = function (a) {
	return {ctor: 'CreateResponse', _0: a};
};
var _user$project$Slide$ToggleResponse = function (a) {
	return {ctor: 'ToggleResponse', _0: a};
};
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'ToggleVisibility':
				...
				var _p1 = A2(_elm_lang$core$Debug$log, 'model', newModel);
				return {
					ctor: '_Tuple2',
					_0: newModel,
					_1: A2(_user$project$Slide$edit, newModel, _user$project$Slide$ToggleResponse)
				};
			case 'ToggleResponse':
			...
			case 'Edit':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$Slide$edit, model, _user$project$Slide$EditResponse)
				};
			case 'EditResponse':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'CreateResponse':
			...
			case 'FileUploaded':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{title: _p2.location, body: _p2.location, type_: _p2.filetype}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _user$project$Slide$viewText = function (model) {
	return A2(
		_elm_lang$html$Html$li,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_user$project$Slide$ToggleVisibility),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_0: _elm_lang$html$Html_Attributes$classList(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'slide__content', _1: true},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'slide__content--visible', _1: model.visible},
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('slide__title'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('slide__body'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _user$project$Slide$deleteButton(model),
				_1: {
					ctor: '::',
					_0: _user$project$Slide$editButton(model),
					_1: {
						ctor: '::',
						_0: _user$project$Slide$slideIndex(model),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Slide$viewImage = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('slide slide--image'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_user$project$Slide$ToggleVisibility),
				_1: {ctor: '[]'}
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_0: _elm_lang$html$Html_Attributes$classList(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'slide__content slide__content--image', _1: true},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'slide__content--visible', _1: model.visible},
								_1: {ctor: '[]'}
...
var _user$project$Slide$viewVideo = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('slide slide--video'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_user$project$Slide$ToggleVisibility),
				_1: {ctor: '[]'}
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_0: _elm_lang$html$Html_Attributes$classList(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'slide__content slide__content--video', _1: true},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'slide__content--visible', _1: model.visible},
								_1: {ctor: '[]'}
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src(model.body),
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$html$Html_Attributes$attribute, 'autoplay', 'true'),
								_1: {
									ctor: '::',
									_0: A2(_elm_lang$html$Html_Attributes$attribute, 'loop', 'true'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('slide__video'),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$Slide$view = function (model) {
	...
	switch (_p3) {
		...
		case 'image':
			return _user$project$Slide$viewImage(model);
		default:
			return _user$project$Slide$viewVideo(model);
	}
};
...
var _user$project$Modal$Model = F3(
	function (a, b, c) {
		return {show: a, id: b, slide: c};
	});
...
var _user$project$Modal$showModalContent = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('modal__content'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Modal$CreateResponse = function (a) {
	return {ctor: 'CreateResponse', _0: a};
};
var _user$project$Modal$createSlide = function (model) {
	return A2(_user$project$Slide$createOrEditSlide, model, _user$project$Modal$CreateResponse);
};
var _user$project$Modal$CreateSlide = {ctor: 'CreateSlide'};
var _user$project$Modal$Edit = function (a) {
	return {ctor: 'Edit', _0: a};
};
var _user$project$Modal$Hide = {ctor: 'Hide'};
var _user$project$Modal$showModalFooter = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('modal__footer'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('button button--cancel'),
					_1: {
						ctor: '::',
						_0: _user$project$Events$onClickStopPropagation(_user$project$Modal$Hide),
						_1: {ctor: '[]'}
					}
				},
				{
					ctor: '::',
					_0: _user$project$Modal$icon('close'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('button button--ok modal__save'),
						_1: {
							ctor: '::',
							_0: _user$project$Events$onClickStopPropagation(_user$project$Modal$CreateSlide),
							_1: {
								ctor: '::',
					...
					{
						ctor: '::',
						_0: _user$project$Modal$icon('check'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Modal$showModal = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('modal__wrapper'),
			_1: {
				ctor: '::',
				_0: _user$project$Events$onClickStopPropagation(_user$project$Modal$Show),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('modal__header'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('New Slide'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$Modal$showModalContent(model),
				_1: {
					ctor: '::',
					_0: _user$project$Modal$showModalFooter(model),
					_1: {ctor: '[]'}
				}
			}
		});
	...
	return A2(
			...
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'modal--visible', _1: model.show},
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('modal__backdrop'),
					_1: {
						ctor: '::',
						_0: _user$project$Events$onClickStopPropagation(_user$project$Modal$Hide),
						_1: {ctor: '[]'}
				...
				{
					ctor: '::',
					_0: _user$project$Modal$showModal(model),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _user$project$Modal$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('slide slide--new-slide'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_user$project$Modal$Show),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('slide__content slide__content--new-slide'),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Modal$showModalBackdrop(model),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Slides$decoder = _elm_lang$core$Json_Decode$list(_user$project$Slide$decoder);
var _user$project$Slides$Model = F2(
	function (a, b) {
		return {slides: a, modal: b};
	});
var _user$project$Slides$NewSlideModal = function (a) {
	return {ctor: 'NewSlideModal', _0: a};
};
var _user$project$Slides$editSlide = F3(
	function (model, newSlides, slide) {
		var _p0 = A2(
			_user$project$Modal$update,
			_user$project$Modal$Edit(slide),
			model.modal);
		var newModal = _p0._0;
		var newModalCmd = _p0._1;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{slides: newSlides, modal: newModal}),
...
var _user$project$Slides$subscriptions = function (model) {
	return A2(
		_elm_lang$core$Platform_Sub$map,
		_user$project$Slides$NewSlideModal,
		_user$project$Modal$subscriptions(model.modal));
};
var _user$project$Slides$Slide = F2(
	function (a, b) {
		return {ctor: 'Slide', _0: a, _1: b};
	});
var _user$project$Slides$updateSlide = F3(
	function (newModel, msg, currentModel) {
		if (_elm_lang$core$Native_Utils.eq(newModel.id, currentModel.id)) {
			var _p1 = A2(_user$project$Slide$update, msg, newModel);
			var newSlide = _p1._0;
			var newCmd = _p1._1;
			return {
				ctor: '_Tuple2',
...
var _user$project$Slides$view = function (model) {
	var newSlide = A2(
		_elm_lang$html$Html$map,
		_user$project$Slides$NewSlideModal,
		_user$project$Modal$view(model.modal));
	return {
		ctor: '::',
		_0: newSlide,
		_1: A2(
...
var _user$project$Slides$SlidesResponse = function (a) {
	return {ctor: 'SlidesResponse', _0: a};
};
var _user$project$Slides$getSlides = A2(
	_elm_lang$http$Http$send,
	_user$project$Slides$SlidesResponse,
	A2(_elm_lang$http$Http$get, '/slides', _user$project$Slides$decoder));
var _user$project$Slides$init = function () {
	var _p2 = _user$project$Modal$init;
	var newModal = _p2._0;
	var newModalCmd = _p2._1;
	return {
		ctor: '_Tuple2',
		_0: A2(
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Slides$NewSlideModal, newModalCmd),
				_1: {
					ctor: '::',
					_0: _user$project$Slides$getSlides,
					_1: {ctor: '[]'}
				}
			})
	};
	...
	function (msg, model) {
		...
		switch (_p3.ctor) {
			...
			default:
				...
				var _p9 = _p10;
				if ((_p9.ctor === 'CreateResponse') && (_p9._0.ctor === 'Ok')) {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
...
var _user$project$Setting$Toggled = function (a) {
	return {ctor: 'Toggled', _0: a};
};
var _user$project$Setting$toggleSetting = function (model) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Setting$Toggled,
		_elm_lang$http$Http$request(
			{
				method: 'PUT',
				headers: {
				...
				url: A2(_elm_lang$core$Basics_ops['++'], '/setting/', model.id),
				body: _elm_lang$http$Http$emptyBody,
				expect: _elm_lang$http$Http$expectString,
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
...
var _user$project$Setting$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('settings__setting'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$button,
				{
					...
					_0: _elm_lang$html$Html_Attributes$classList(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'settings__toggle', _1: true},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'settings__toggle--enabled', _1: model.value},
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Setting$Toggle),
						_1: {ctor: '[]'}
					}
				},
				{
					ctor: '::',
					_0: _user$project$Setting$icon(
...
var _user$project$Settings$Settings = function (a) {
	return {ctor: 'Settings', _0: a};
};
var _user$project$Settings$getSettings = A2(
	_elm_lang$http$Http$send,
	_user$project$Settings$Settings,
	A2(_elm_lang$http$Http$get, '/settings', _user$project$Settings$decoder));
	...
	function (msg, model) {
		...
		if (_p1.ctor === 'SettingMsg') {
			...
			if (_p1._0.ctor === 'Err') {
				...
				return {
					ctor: '_Tuple2',
					_0: _user$project$Settings$Model(_p1._0._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			}
		}
...
var _user$project$Main$init = function () {
	...
	return {
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$SlideList, slidesCmd),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$SettingsMsg, settingsCmd),
					_1: {ctor: '[]'}
				}
			})
	};
...
var _user$project$Main$view = function (model) {
	...
	var slides = A2(
		_elm_lang$core$List$map,
		function (slide) {
			return A2(_elm_lang$html$Html$map, _user$project$Main$SlideList, slide);
		},
		_user$project$Slides$view(model.slides));
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Switcharoo'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Main$subscriptions = function (model) {
	return A2(
		_elm_lang$core$Platform_Sub$map,
		_user$project$Main$SlideList,
		_user$project$Slides$subscriptions(model.slides));
};
