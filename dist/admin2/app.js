...
var _user$project$Slide$encodeSlide = function (model) {
	return _elm_lang$core$Json_Encode$object(
		A2(
			_elm_lang$core$List$append,
			_elm_lang$core$Native_Utils.eq(model.id, '') ? _elm_lang$core$Native_List.fromArray(
				[]) : _elm_lang$core$Native_List.fromArray(
				[
					{
					ctor: '_Tuple2',
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					ctor: '_Tuple2',
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(model.type$)
				}
				])));
};
var _user$project$Slide$editSlide = function (model) {
	return A2(
...
var _user$project$Slide$createSlide = function (model) {
	return A2(
		_evancz$elm_http$Http$send,
		_evancz$elm_http$Http$defaultSettings,
		{
...
var _user$project$Slide$createOrEditSlide = function (model) {
	return _elm_lang$core$Native_Utils.eq(model.id, '') ? _user$project$Slide$createSlide(model) : _user$project$Slide$editSlide(model);
};
...
var _user$project$Slide$CreateFailed = function (a) {
	return {ctor: 'CreateFailed', _0: a};
};
var _user$project$Slide$create = function (model) {
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Slide$CreateFailed,
		_user$project$Slide$CreateSucceeded,
		_user$project$Slide$createSlide(model));
};
var _user$project$Slide$EditSucceeded = function (a) {
	return {ctor: 'EditSucceeded', _0: a};
};
var _user$project$Slide$EditFailed = function (a) {
	return {ctor: 'EditFailed', _0: a};
};
var _user$project$Slide$edit = function (model) {
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Slide$EditFailed,
		...
		switch (_p0.ctor) {
			case 'ToggleVisibility':
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						visible: _elm_lang$core$Basics$not(model.visible)
					});
				return {
					ctor: '_Tuple2',
					_0: newModel,
...
var _user$project$Slides$editSlide = F3(
	function (newModel, msg, currentModel) {
		if (_elm_lang$core$Native_Utils.eq(newModel.id, currentModel.id)) {
			var _p0 = A2(_user$project$Slide$update, msg, newModel);
			var newSlide = _p0._0;
			var newCmd = _p0._1;
			return {
				ctor: '_Tuple2',
...
var _user$project$Slides$GetSucceeded = function (a) {
	return {ctor: 'GetSucceeded', _0: a};
};
var _user$project$Slides$getSlides = A3(
	_elm_lang$core$Task$perform,
	_user$project$Slides$GetFailed,
	_user$project$Slides$GetSucceeded,
	A2(_evancz$elm_http$Http$get, _user$project$Slides$decoder, '/slides'));
var _user$project$Slides$init = {
	ctor: '_Tuple2',
	_0: _user$project$Slides$Model(
		_elm_lang$core$Native_List.fromArray(
			[])),
	_1: _user$project$Slides$getSlides
};
...
var _user$project$Modal$CreateFailed = function (a) {
	return {ctor: 'CreateFailed', _0: a};
};
var _user$project$Modal$createSlide = function (model) {
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Modal$CreateFailed,
		_user$project$Modal$CreateSucceeded,
		_user$project$Slide$createOrEditSlide(model));
};
...
var _user$project$Modal$showModalFooter = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('modal__footer')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('button button--cancel'),
						_user$project$Events$onClickStopPropagation(_user$project$Modal$Hide)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Modal$icon('close')
					])),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Modal$icon('check')
					]))
			]));
};
...
var _user$project$Modal$showModal = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('modal__wrapper'),
				_user$project$Events$onClickStopPropagation(_user$project$Modal$Show)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('modal__header')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('New Slide')
					])),
				_user$project$Modal$showModalContent(model),
				_user$project$Modal$showModalFooter(model)
			]));
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('modal__backdrop'),
						_user$project$Events$onClickStopPropagation(_user$project$Modal$Hide)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Modal$showModal(model)
					]))
			]));
};
var _user$project$Modal$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('slide slide--new-slide'),
				_elm_lang$html$Html_Events$onClick(_user$project$Modal$Show)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Modal$showModalBackdrop(model)
					]))
			]));
};
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {slides: a, newSlide: b};
	});
var _user$project$Main$NewSlide = function (a) {
	return {ctor: 'NewSlide', _0: a};
};
	...
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$core$Platform_Sub$map,
				_user$project$Main$NewSlide,
				_user$project$Modal$subscriptions(model.newSlide))
			]));
};
...
var _user$project$Main$init = function () {
	var _p0 = _user$project$Modal$init;
	var newSlide = _p0._0;
	var newSlideCmd = _p0._1;
	var _p1 = _user$project$Slides$init;
	var slides = _p1._0;
	var slidesCmd = _p1._1;
	return {
		ctor: '_Tuple2',
		_0: A2(_user$project$Main$Model, slides, newSlide),
		_1: _elm_lang$core$Platform_Cmd$batch(
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$SlideList, slidesCmd),
					A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$NewSlide, newSlideCmd)
				]))
	};
}();
		...
		return A2(
			...
			function () {
				...
				if (_p2.ctor === 'SlideList') {
					...
					var _p7 = _p2._0;
					var _p4 = A2(_user$project$Modal$update, _p7, model.newSlide);
					var newSlide = _p4._0;
					var newSlideCmd = _p4._1;
					var _p5 = _p7;
					if (_p5.ctor === 'CreateSucceeded') {
						var _p6 = A2(_user$project$Slides$update, _user$project$Slides$GetSlides, model.slides);
						var newSlideCmd$ = _p6._1;
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
							...
							_1: _elm_lang$core$Platform_Cmd$batch(
								_elm_lang$core$Native_List.fromArray(
									[
										A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$SlideList, newSlideCmd$),
										A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$NewSlide, newSlideCmd)
									]))
						};
					} else {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{newSlide: newSlide}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$NewSlide, newSlideCmd)
						};
					}
				}
			}());
...
var _user$project$Main$view = function (model) {
	var slides = A2(
		_elm_lang$core$List$map,
		function (slide) {
			return A2(_elm_lang$html$Html_App$map, _user$project$Main$SlideList, slide);
		},
		_user$project$Slides$view(model.slides));
	var newSlide = A2(
		_elm_lang$html$Html_App$map,
		_user$project$Main$NewSlide,
		_user$project$Modal$view(model.newSlide));
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(_elm_lang$core$List_ops['::'], newSlide, slides))
			]));
};
