...
/***/ function(module, exports, __webpack_require__) {
	...
	var _slides = __webpack_require__(4);
	...
	var _slideText = __webpack_require__(36);
	
	var _slideText2 = _interopRequireDefault(_slideText);
	
	var _slideImage = __webpack_require__(37);
	...
	var app = _backbone2.default.View.extend({
		...
		initialize: function initialize(options) {
			this.template = _app2.default;
			this.slides = new _slides2.default.view({ collection: new _slides2.default.collection() });
			this.settings = new _settings2.default.view({ collection: new _settings2.default.collection() });
			_backbone2.default.Events.on('slide:edit', this.edit, this);
			_backbone2.default.Events.on('slide:edit:close', this.close, this);
			_backbone2.default.Events.on('slide:remove', this.remove, this);
		},
		...
		assign: function assign(view, selector) {
			...
			(0, _jquery2.default)(selector).append(view.setElement(container).render());
		},
	
		edit: function edit(slide) {
			var template = slide.get('type') === 'text' ? _slideText2.default : _slideImage2.default;
			this.slideEdit = new _slide2.default.view({ template: template });
		...
		editText: function editText(slide) {
			this.slideEdit = new _slide2.default.view({ template: _slideText2.default });
			this.slideEdit.model = model;
			this.assign(this.slideEdit, '.slide-edit');
		},
	
		editImage: function editImage(slide) {
			this.imageSlideEdit.model = slide;
			this.assign(this.imageSlideEdit, '.slide-edit');
		},
	
		createTextSlide: function createTextSlide() {
			this.slideEdit = new _slide2.default.view({ template: _slideText2.default });
			var model = new _slide2.default.model();
			model.set('type', 'text');
			this.slideEdit.model = model;
			this.assign(this.slideEdit, '.slide-edit');
		},
	
		createImageSlide: function createImageSlide() {
			this.slideEdit = new _slide2.default.view({ template: _slideImage2.default });
	...
	var view = new app({ el: (0, _jquery2.default)('.container') });
	view.render();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _slide3 = __webpack_require__(26);
	...
	var view = _backbone2.default.View.extend({
		...
		initialize: function initialize(options) {
			this.template = _slides2.default;
			this.collection.on('sync remove', this.render, this);
			this.collection.fetch();
			_backbone2.default.Events.on('slides:reload', this.collection.fetch, this);
		},
		...
		render: function render() {
			...
			this.collection.each(function (model) {
				var view = new _slide2.default.view({ model: model, template: _slide4.default });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var view = _backbone2.default.View.extend({
		...
		edit: function edit(event) {
			_backbone2.default.Events.trigger('slide:edit', this.model);
		},
	
		deleteSlide: function deleteSlide(event) {
			if (!confirm("Do you really want to delete the slide \"" + this.model.get('title') + "\"")) return;
	
			_backbone2.default.Events.trigger('slide:remove', this);
		},
	
		save: function save(event) {
			if (event) event.preventDefault();
	
			var body = this.model.get('type') === 'image' ? this.$el.find('.image-link').text() : this.$el.find('textarea[name="body"]').val();
			...
			this.model.save();
			_backbone2.default.Events.trigger('slide:edit:close');
		},
		...
		uploadImage: function uploadImage(event) {
			...
			_jquery2.default.ajax({
				...
				type: 'POST',
				xhr: function xhr() {
					var myXhr = _jquery2.default.ajaxSettings.xhr();
					return myXhr;
				},
				success: function success(res) {
					self.$el.find('.image-link').attr('href', res.filepath).text(res.filepath);
				},
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"slide\">\n    <div class=\"visible visible-"
	    + alias4(((helper = (helper = helpers.visible || (depth0 != null ? depth0.visible : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"visible","hash":{},"data":data}) : helper)))
	    ...
	    + "</div>\n        <div class=\"actions\">\n            <button class=\"btn action action-edit\">Edit</button>\n            <button class=\"btn action action-delete\">Delete</button>\n        </div>\n    </div>\n</div>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var view = _backbone2.default.View.extend({
	    ...
	    initialize: function initialize(options) {
	        this.template = _settings2.default;
	        this.collection.on('sync', this.render, this);
	        this.collection.fetch();
	        _backbone2.default.Events.on('settings:reload', this.collection.fetch, this);
	    },
	    ...
	    render: function render() {
	        ...
	        this.settings = [];
	        this.collection.each(function (model) {
	            var view = new _setting2.default.view({ model: model });
	            self.settings.push(view);
	            container.appendChild(view.render());
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var view = _backbone2.default.View.extend({
	    ...
	    initialize: function initialize(options) {
	        this.template = _setting2.default;
	        if (this.model) this.model.on('change', this.render, this);
	    },
	    ...
	    toggleEnabed: function toggleEnabed(event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"settings\"></div>\n<div class=\"slides\"></div>\n<div class=\"slide-edit\"></div>\n<button class=\"btn text-slide\">Text slide</button>\n<button class=\"btn image-slide\">Image slide</button>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"slide-edit-form\">\n    <form>\n        <label class=\"text-input\"><span>Tittel</span><input type=\"text\" name=\"title\" value=\""
	    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
	    + "\" placeholder=\"Title\" /></label>\n        <label class=\"text-input\"><span>Indeks</span><input type=\"text\" name=\"index\" value=\""
	    + alias4(((helper = (helper = helpers.index || (depth0 != null ? depth0.index : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"index","hash":{},"data":data}) : helper)))
	    + "\" class=\"index\" /></span></label>\n        <label><span>Tekst</span><textarea name=\"body\" placeholder=\"Tekst\">"
	    + alias4(((helper = (helper = helpers.body || (depth0 != null ? depth0.body : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"body","hash":{},"data":data}) : helper)))
